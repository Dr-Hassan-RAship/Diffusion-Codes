...
# Purpose                   : Defines a spatial self-attention U-Net with residual blocks
#
# Usage                     : Imported in the training script for latent space modeling.
#
...
class ResBlock(nn.Module):
    """Two-layer residual block with optional skip connection."""
