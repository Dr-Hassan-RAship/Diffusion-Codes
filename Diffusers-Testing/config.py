...
class InferenceConfig:
    ...
    MODEL_EPOCHS = [
        450
    ]  # 400: 78.27, 800: 80.77, 895: 79.02, 500: 76.3, 450: 79.06            # Epoch of the list of models to load.
    ...
    SAVE_FOLDER = (
        LDM_SNAPSHOT_DIR
        + f"/inference-M{MODEL_EPOCHS if MODEL_EPOCHS != -1 else N_EPOCHS}-E{N_EPOCHS}-t{NUM_TRAIN_TIMESTEPS}-S{SCHEDULER}-SP{NUM_SAMPLES}-It{INFERENCE_TIMESTEPS}"
    )  # Save folder for inference results
