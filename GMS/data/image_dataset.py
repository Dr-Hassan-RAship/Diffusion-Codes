...
class Image_Dataset(Dataset):
    ...
    # [CHANGED] --> Removed always_apply=True as it is giving error or warning
    def get_transforms(self):
        if self.stage == 'train':
            transforms = A.Compose([
    ...
    def __getitem__(self, index):
        ...
        # load img & seg
        # [CHANGED] --> from .png to jpg as Kvasir-SEG has .jpg files. Also note both image and mask are being loaded as RGB
